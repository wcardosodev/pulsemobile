...
function sendMessage() {
	var message_list = $('#msg-list'),
			...
			// add msg to the list
			message_list.append('<div class="msg"><div class="sent"><div class="msg-header"><span class="time">' + now_hour + ':' + now_minute + ' | ' + months[d.getMonth()] + ' ' + d.getDate() + '</span></div><div class="msg-body"><p>' + message + '</p></div></div></div>');
